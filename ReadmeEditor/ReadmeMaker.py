...
def printCount():
    ...
    print getNoOfQuestions()*1.0/totalQuestions
    o.write('### Thats almost ' + str(round(getNoOfQuestions() / totalQuestions * 100.0, 2)) + '% of all of leecode! \n')
    o.write('___\n')
...
def printLog():
    ...
    printTableRow("-:", ":-")
    printTableRow("January 30, 2018:", "**198**")
    printTableRow("December 30, 2017:", "**195**")
    printTableRow("November 30, 2017:", "**195**")
